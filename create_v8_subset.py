"""
创建 qwen_ready_v8 子集数据集
只包含 1 条指定的原始轨迹: 00001
"""
import os
import json
import numpy as np
...
OUTPUT_DIR = DATA_DIR / "qwen_ready_v8"
...
def main():
    ...
    train_path = OUTPUT_DIR / "train_v8.jsonl"
    val_path = OUTPUT_DIR / "val_v8.jsonl"
    test_path = OUTPUT_DIR / "test_v8.jsonl"
